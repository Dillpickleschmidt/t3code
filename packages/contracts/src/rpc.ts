...
export const WsOrchestrationGetToolCallInputRpc = Rpc.make(
  ORCHESTRATION_WS_METHODS.getToolCallInput,
  {
    payload: OrchestrationGetToolCallInputInput,
    success: OrchestrationRpcSchemas.getToolCallInput.output,
    error: Schema.Union([OrchestrationGetToolCallInputError, EnvironmentAuthorizationError]),
  },
);
...
export const WsRpcGroup = RpcGroup.make(
  ...
  WsOrchestrationGetToolCallInputRpc,
